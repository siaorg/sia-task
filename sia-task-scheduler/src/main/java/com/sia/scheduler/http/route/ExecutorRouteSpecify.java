 ...
 *
 * The strategy is based on the specified ip as the target executor
 *
 * @see
 * @author maozhengwei
...
public class ExecutorRouteSpecify extends AbstractExecutorRouter {
    ...
    public String routeRun(JobMTask taskKey, List<String> addressList) {
        if (addressList.isEmpty()){
            logger.warn(Constants.LOG_PREFIX + " enums address fail, ApplicationInstanceList is empty, jobKey={} taskKey={}",taskKey.getJobKey(),taskKey.getTaskKey());
            return null;
        }else{
