...
/*        if (!nacosClient.existNacosService(OnlineTaskConstant.NACOS_ONLINE_TASK, onlineTaskAppProperty.getGroupName())){
        ...
        try{
            ...
            for (Map.Entry<String, OnlineTaskPojo> onlineTaskEntry : onlineTask.entrySet()){
                ...
                nacosClient.deleteNacosInstance(OnlineTaskConstant.NACOS_ONLINE_TASK, onlineTaskAppProperty.getGroupName(), taskKey, onlineTaskAppProperty.getIPAndPort(), true);
                nacosClient.createNacosInstance(OnlineTaskConstant.NACOS_ONLINE_TASK, onlineTaskAppProperty.getGroupName(), taskKey, onlineTaskAppProperty.getIPAndPort(), buildTaskMetaData(instance), true);
